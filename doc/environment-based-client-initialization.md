...
import { Client, Configuration } from 'colorado-booth-sdk';
...
API_KEY_TOKEN=token
API_KEY_API_KEY=api-key
API_HEADER_TOKEN=token
API_HEADER_API_KEY=api-key
O_AUTH_CCG_O_AUTH_CLIENT_ID=oauthclientid
O_AUTH_CCG_O_AUTH_CLIENT_SECRET=oauthclientsecret
O_AUTH_CCG_O_AUTH_CLOCK_SKEW=0
O_AUTH_ACG_O_AUTH_CLIENT_ID=oauthclientid
O_AUTH_ACG_O_AUTH_CLIENT_SECRET=oauthclientsecret
O_AUTH_ACG_O_AUTH_REDIRECT_URI=oauthredirecturi
O_AUTH_ACG_O_AUTH_CLOCK_SKEW=0
O_AUTH_ROPCG_O_AUTH_CLIENT_ID=oauthclientid
O_AUTH_ROPCG_O_AUTH_CLIENT_SECRET=oauthclientsecret
O_AUTH_ROPCG_O_AUTH_USERNAME=oauthusername
O_AUTH_ROPCG_O_AUTH_PASSWORD=oauthpassword
O_AUTH_ROPCG_O_AUTH_CLOCK_SKEW=0
O_AUTH_BEARER_TOKEN_ACCESS_TOKEN=accesstoken
